...
--             AND PCD.NCERTIF = C.NCERTIF)
 ...
 SELECT * FROM CERTIFICAT C 
 WHERE  C.NPOLICY  = 250005860
   AND C.NCERTIF = 4054
 ...
 WHERE  C.NPOLICY  = 250005860
   ...
   update COMMISSION set deffecdate = '24/01/2017'
 WHERE  NPOLICY  = 250005860
   AND NCERTIF = 4054
   
    SELECT * FROM PREMIUM C 
 WHERE  C.NPOLICY  = 30000001
   AND C.NCERTIF = 535
   
   SELECT * FROM PREMIUM_MO WHERE NRECEIPT = 214572492
   
    SELECT * FROM PREMIUM WHERE NRECEIPT = 214572492